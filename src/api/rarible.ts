...
const RARIBLE_MARKETPLACE_URL =
  'https://api-mainnet.rarible.com/marketplace/api/v4';
...
export async function getOwnershipByItem(
  contractAddr: string,
  tokenId: string,
  blockchain = 'ETHEREUM'
) {
...
export async function getOwnerDetails(ownersIds: string[]) {
