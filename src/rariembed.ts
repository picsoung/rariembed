      ...
      if (owners && owners.length > 0) {
        ...
        this.owners = ownerDetails.map((o: any) => {
          return {
            ...
            avatar: o.image
                    ? `https://img.rarible.com/prod/image/upload/t_avatar_big/prod-users/${
                        o.id
                      }/avatar/${o.image.replaceAll('ipfs://ipfs/', '')}`
    ...
    await fetch(
      ...
      .then((res) => {
        ...
        this.collectionAvatar = res.pic
          ? `https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/${
              this.contractAddress.replace(':','-')
            }/avatar/${res.pic.replaceAll('ipfs://ipfs/', '')}`
          : 'https://theme.zdassets.com/theme_assets/10342982/bb8d2a7ec0e54ad27a114410b18e9716a3bf9883.png';
      })
      .catch((error) => {
        // Your error is here!
          ...
          ${this.owners && this.owners.length > 0
            ? html`
                <div>
                  ...
                  <div class="collection">
                  ${this.owners.map((owner: any) =>
                    html `<div class="flex avatar-container">
                        <img
                          class="avatar"
                          src="${owner.avatar}"
                          alt="${owner.name}"
